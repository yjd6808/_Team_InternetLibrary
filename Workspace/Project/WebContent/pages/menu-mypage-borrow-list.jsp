...
<body>
		...
		<div class="container-xxl mt-2 p-0 w-100">
			<div class="main-content">
				<jsp:include page="left-content-mypage.jsp">
					<jsp:param value="<%= MyPageConstant.MY_PAGE_BORROW_LIST %>" name="selectedMenu"/>
				</jsp:include>
				<div class="right-content d-flex flex-column gap-2" style="width: 100%">
					<h4 class="mt-3 mb-3 fw-bold ms-1">대여 도서 목록</h4>
					<div class="border-container px-4">
						<table class="table my-book-table" id="result-table">
							<thead class="fw-bold">
								<tr>
									<td style="width: 10%;">도서 번호</td>
									<td>도서명</td>
									<td style="width: 14%;">대여 시작</td>
									<td style="width: 14%;">대여 종료</td>
									<td style="width: 20%;">남은 시간</td>
								</tr>
							</thead>
							<tbody>
								<tr>
	...
	<script src="../js/menu-mypage-borrow-list.js" charset="utf-8"></script>
